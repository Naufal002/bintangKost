...
<?php
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar2"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav align-items-center justify-content-end align-items-center flex-grow-1 ">
              ...
              <a class="nav-link me-md-4 text-center" href="kamar.php" role="button"
  ...
  <section id="billboard">
    <div class="container ">
      <div class="row flex-lg-row-reverse align-items-center ">
        ...
        <div class="col-lg-6">
          <img src="../images/kos6.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700"
            height="500" loading="lazy">
        </div>

        <div class="col-lg-6">
          <h4 class=" text-capitalize  lh-1 my-3">Nyari kost susah banget?!</h4>
          <h1 class=" text-capitalize  lh-1 my-3">Bintang Kost Aja</h1>
          <p class="lead">Pilihan kost ideal dengan fasilitas lengkap dan harga terjangkau.</p>
              ...
              <div class="row billboard-row">
                ...
                <div class="col-lg-3 billboard-select">
                  <select class="form-select mb-2 mb-lg-0" aria-label="Location">
                    <option selected>Kampus & Sekolah</option>
                    <option value="1">Universitas Muria Kudus</option>
                    <option value="2">UIN Sunan Kudus</option>
                    <option value="3">Universitas Muhammadiyah Kudus</option>
                    <option value="4">SMK Raden Umar Said Kudus</option>
                  </select>
                </div>
                <div class="col-lg-3 billboard-select">
                ...
                <div class="col-lg-3 billboard-btn">
                  <button type="submit" class="btn btn-primary btn-lg billboard-search">Cari kamar</button>
                </div>
              </div>
    ...
    <div class="container py-5">
      <div class="row">
        <div class="section-header align-center mb-5">
          <h2 class=" text-capitalize m-0">Kampus & Sekolah terdekat</h2>
        </div>
      </div>
      <div class="row d-flex justify-content-between">
        <div class="col-md-2 ">
          <div class="my-3" role="group" aria-label="3 / 7" style="width: 158.667px; margin-right: 20px;"><img
              alt="image" style="width: 178px;" src="../assets/smk_rus.png"></div>
        </div>
        <div class="col-md-2">
          <div class="my-3" role="group" aria-label="3 / 7" style="width: 158.667px; margin-right: 20px;"><img
              alt="image" style="width: 200px;" src="../assets/iain.png"></div>
        </div>
        <div class="col-md-2">
          <div class="my-3" role="group" aria-label="3 / 7" style="width: 158.667px; margin-right: 20px;"><img
              alt="image" style="width: 200px;" src="../assets/umk.png"></div>
        </div>
        <div class="col-md-2">
          <div class="my-3" role="group" aria-label="3 / 7" style="width: 158.667px; margin-right: 20px;"><img
  ...
  <section id="residence">
    <div class="container  my-5 py-5">
      <h2 class="text-capitalize m-0 py-lg-5">Rekomendasi kamar</h2>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                <a href="index.html">
                  <h5 class="card-title pt-4">Kamar-Minimalis</h5>
                </a>
                <p class="card-text">Nyaman dan luas harga terjangkau</p>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                <a href="index.html">
                  <h5 class="card-title pt-4">Kamar-Mendang mending</h5>
                </a>
                <p class="card-text">Murah terjangkau</p>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                <a href="index.html">
                  <h5 class="card-title pt-4">Kamar-Sultan</h5>
                </a>
                <p class="card-text">Untuk kaum para sultan yang banyak uang</p>

                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"> <img src="../images/bed.png" alt="image"> 3 Kasur</li>
                    <li class="residence-list"> <img src="../images/bath.png" alt="image"> 3 Bath</li>
                    <li class="residence-list"> <img src="../images/square.png" alt="image"> 6x8m</li>
                  </ul>
                </div>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                <a href="index.html">
                  <h5 class="card-title pt-4">Kamar-UMR</h5>
                </a>
                <p class="card-text">Untuk gaji UMR dibawah 100rb</p>

                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"> <img src="../images/bed.png" alt="image"> 1 Kasur</li>
                    <li class="residence-list"> <img src="../images/bath.png" alt="image"> 1 bath</li>
                    <li class="residence-list"> <img src="../images/square.png" alt="image"> 3x2m</li>
                  </ul>
                </div>
          ...
          <div class="swiper-slide">
            <div class="card">
              ...
              <div class="card-body p-0">
                <a href="index.html">
                  <h5 class="card-title pt-4">Kamar-PlinPlan</h5>
                </a>
                <p class="card-text">Untuk kaum mendang-mending</p>

                <div class="card-text">
                  <ul class="d-flex">
                    <li class="residence-list"> <img src="../images/bed.png" alt="image"> 1 bed</li>
                    <li class="residence-list"> <img src="../images/bath.png" alt="image"> 1 bath</li>
                    <li class="residence-list"> <img src="../images/square.png" alt="image"> 3x4m</li>
                  </ul>
                </div>
      ...
      <div class="residence-btn">
        <a href="kamar.php" class="btn btn-primary btn-lg my-5">Rekomendasi kamar lainnya</a>
      </div>
  ...
  <section id="about-us">
    <div class="container">
      <div class="row py-lg-5">
        ...
        <h2 class="text-capitalize text-center m-0 py-lg-5">Kenapa memilih Bintang Kos</h2>
        ...
        <div class="text-center col-lg-4">
          ...
          <h4 class="fw-normal mt-5 ">Mudah dicari</h4>
          <p>Bintang kos menyediakan banyak rekomedasi kamar kos dengan harga terjangkau sampai dengan kelas sultan</p>
        </div>

        <div class="text-center col-lg-4">
          <img src="../images/price.png" class="bd-placeholder-img rounded-circle" alt="Bootstrap Themes" width="140"
            height="140" loading="lazy">
          <h4 class="fw-normal mt-5">Harga affordable</h4>
          <p>Di Bintang Kost dapat menyewa kamar kos dengan harga UMR sampai dengan harga SULTAN</p>
        </div>

        <div class="text-center col-lg-4">
          <img src="../images/time.png" class="bd-placeholder-img rounded-circle" alt="Bootstrap Themes" width="140"
            height="140" loading="lazy">
          <h4 class="fw-normal mt-5 ">Respon cepat dari admin</h4>
          <p>Di Bintang Kos respon dan tanggapan admin cepat dan ramah untuk para coustomer</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="row my-5 py-lg-5">
              <div class="col-md-8 mx-auto">
                ...
                <p class="testimonial-p mt-4">Kami menyediakan kamar kost mulai dengan harga UMR sampai harga SULTAN untuk para mahasiswa dan kaum pelajar dari luar kota dan untuk kalian yang rumahnya jauh.</p>

                <div class="row">
                  <div class="col-md-8">
                    <p class="pt-5 mb-1">Bintang Adhipura</p>
                    <p class="">Ceo Bintang Kos</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="row my-5 py-lg-5">
              <div class="col-md-8 mx-auto">
                <img src="../images/quote.png" class="rounded mx-auto d-inline" alt="...">
                <p class="testimonial-p mt-4">Kami berperan besar untuk membantu anda meraih masa depan dengan bintang kos dengan menyediakan kamar dengan harga affordable dan kasur yang super EMPUK</p>

                <div class="row">
                  <div class="col-md-8">
                    <p class="pt-5 mb-1">Vannesco</p>
                    <p class="">Coo Bintang Kos</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-6">
          <div class="text-content ps-md-5 mt-4 mt-md-0">
            <h2 class="text-capitalize">Kami membantu menemukan kost yang dibutuhkan </h2>
            ...
            <a href="https://wa.me/6285602494352" class="btn btn-primary btn-lg">Message me!!!</a>
          </div>
        </div>
    ...
    <div class="container my-5 py-5">
      <div class="row featurette py-lg-5 ">
        <div class="col-md-5 order-md-1 d-flex">
          <h1 class="text-capitalize  lh-1 mb-3">Ayo tunggu apa lagi, Pesan sekarang juga!!!</h1>
        </div>
